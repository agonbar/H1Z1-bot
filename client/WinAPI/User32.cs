...
namespace H1Z1Bot.WinAPI
{
    public static class User32
    {
        ...
        public enum MouseEventDataXButtons : uint
        {
            ...
            XBUTTON8 = 0x00000008,
            XBUTTON9 = 0x00000009,
            XBUTTON10 = 0x000000010,
            XBUTTON11 = 0x000000011,
            XBUTTON12 = 0x000000012
        }

        [DllImport("user32.dll")]
        private static extern void _mouse_event(uint dwFlags, uint dx, uint dy, uint dwData, int dwExtraInfo);
        ...
        public static bool RegisterHotKey(IntPtr hwnd, int id, ModifierKeys modkey, VirtualKey key)
        {
            return _RegisterHotKey(hwnd, id, (uint)modkey, (uint)key);
        }
        ...
        public enum ModifierKeys : uint
        {
            ...
            Shift = 1 << 2,
            Windows = 1 << 3,
            [Description("Changes the hotkey behavior so that the keyboard auto-repeat does not yield multiple hotkey notifications. (Windows Vista not supported)")]
            NoRepeat = 0x4000
        }
